...
3. Nakonec je potřeba zprovoznit Vizualizační aplikaci
	...
	3.3. Následně ji spustíme příme ve Visual Studiu nebo pomocí exe souboru ve Vizualizace Dat/Vizualizace Dat/bin/Debug/Vizualizace Dat.exe
...
1. Webová Služba
	...
	1.3. Chybové hlášky
		...
		1.3.2. Chybová stránka obsahuje data json soubor s parametrem message obsahujícím informace o tom proč k chybě došlo ({"message": "Žádný ze zvolených datových zdrojů neobsahuje bitmapu se zvoleným časem a typem předpovědi! Zkuste změnit čas případně zadaný typ."})
2. Vizualizační Aplikace
	...
	2.3. Počasí v bodě
		...
		2.3.2. Stejně tak máme možnost napsat název místa do textového pole v levé horní částí a potvrdíme kliknutím na vyhledat
	...
	2.6. Animace
		2.6.1. Při kliknutí na zelené tlačítko PLAY v pravé dolní části aplikace dochází k vykreslení animace
		2.6.2. Animace má zvolený počet kroků a nastavitelný časový rozdíl mezi kroky
		2.6.3. Animace vykresluje bitmapu s dato o počasí na mapu pro aktuální čas animace
...
1. Agregace Dat
	1.1. Přidání datových zdrojů
		...
		1.1.2. Vložením nového dll souboru dochází k přidání nového danotého zdroje, který se načte za běhu pomocí reflexe
		...
		1.1.4. Zdroj musí implementovat rozhraní DataLoader a soubor + namespace musí nást název DLNazevLoaderuLib.dll, knihovna musí nést název NazevLoaderuDataLoader
	1.2. Úprava aktuálních datových zdrojů	
		...
		1.2.3. Případně je možné změnit hdonotu proměnné inDebug v Agregaci Dat -> AvgForecast na true a budou se používat dll soubory z bin adresářů
	...
	1.5. Změna vlastností zdrojů
		...
		1.5.2. Tento soubor se nachazí na Webova Sluzba\Webova Sluzba\Data\NÁZEV_ZDROJE\loaderConfig.json a je možné změnit jeho parametry
2. Webová Služba
	2.1. Změna času opakujícího se požadavku na znovuvykreslení bitmap
		2.1.1. Pokud nechceme aby naše webová služba prováděla kontrolu bitmap co hodinu ale častěji/méně často musíme odkomentovat jeden ze řádků v kódu
