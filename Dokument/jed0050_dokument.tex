...
\begin{document}
	...
	- json obsahuje zkratky a časy nové v hodiních do nové generace a čas psolední generace, omezení atp
	- vlastní složka bmp, škály, konf s
	
	\section{Zpracovávání dat}
	
	- teď jdeme po bodech
	- tříve se braly souřadnice zjišťovaných měst
	
	- plochu, zvětšit, zmenšit a přímo zpracovat
	
	- obrázek matice barev
	- obrázek triangulace
	- obrázek finální bitmapy
	...
	- bitmapa 
	- časy
	- pokud zpracovává co 10 min vrací nejbližších 10 min, pokud zpracovává co 6 hodin vrací njebližší čas v 6 h pásmu
