...
\begin{document}
	...
	\lstset{
		...
		tabsize=3,
		%frame=lines,
		caption=Ukázka XML dat od Yr.no,
		label=code:sample,
		frame=shadowbox,
		...
		emph={temperature, precipitation, humidity, pressure},emphstyle={\color{magenta}}}
	\lstinputlisting{Data/Yrno_ukazka.xml}
	...
	\lstinputlisting{Data/Owm_ukazka.json}
	...
	\lstinputlisting{Data/Weun_ukazka.json}
